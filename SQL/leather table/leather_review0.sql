...
CREATE TABLE `review` (
  ...
  `review_upload_no` int(11) DEFAULT NULL,
  ...
  KEY `review_upload_no_idx` (`review_upload_no`),
  CONSTRAINT `review_product_code` FOREIGN KEY (`review_product_code`) REFERENCES `product` (`product_code`),
  CONSTRAINT `review_upload_no` FOREIGN KEY (`review_upload_no`) REFERENCES `upload` (`upload_no`),
...
INSERT INTO `review` VALUES (1,'b123','thread001001',NULL,'너무좋아요','2019-05-03 15:10:39'),(12,'b123','tool001001',NULL,'배송이 빨라요 ','2019-05-03 15:52:07'),(21,'c123','tool001001',NULL,'좋아요','2019-05-03 16:06:27'),(22,'c123','thread001003',NULL,'다음에또사고싶어요','2019-05-03 16:06:59'),(23,'c123','thread001002',NULL,'굿','2019-05-03 16:07:22');
